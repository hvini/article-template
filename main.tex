...
\autor{ \thanks{Caso tenha tido orientação de algum professor, ele deverá ser colocado por último na ordem de autoria.}Equipe \abnTeX$^1$ \and Lauro César Araujo$^2$ }

\local{Brasil}

\data{
$^1${``Recomenda-se que os dados de vinculação e
...
$^2${``Constar currículo sucinto de cada autor, com 
